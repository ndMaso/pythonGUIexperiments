...
class DdrFile:
    # holds the notes in sequence with uldr = 1234, and indexed with beat number divided by 12
    # has methods used to set/create a ddrfile and can be saved, class Reader, takes
    def __init__(self, transcript, bpm=80, divisions_per_beat=4, beats_before_note=4):
